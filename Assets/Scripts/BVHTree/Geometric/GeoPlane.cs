...
namespace Nullspace
{
    public class GeoPlane
    {
        ...
        public GeoPlane(Vector3 normal, float d)
        {
            mNormal = normal;
            mD = d;
        }
        ...
        public GeoPlane(Vector3 p1, Vector3 p2, Vector3 p3)
        {
            mAxisX = p2 - p1;
            mAxisX.Normalize();
            mAxisZ = p3 - p1;
        ...
        // must 左手坐标系
        public GeoPlane(Vector3 axisX, Vector3 axisY, Vector3 axisZ, Vector3 p)
        {
            mAxisX = axisX;
            mNormal = axisY;
            mAxisZ = axisZ;
