...
namespace Nullspace
{
    namespace Voronoi2
    {
        ...
        public class Voronoi
        {
            ...
            private double minSquareDistanceBetweenSites;
            private int PQcount;
            private int PQmin;
            ...
            // constructor
            public Voronoi(double minSquareDistanceBetweenSites = 0.0001f)
            {
                siteidx = 0;
                sites = null;

                allEdges = null;
                this.minSquareDistanceBetweenSites = minSquareDistanceBetweenSites;
            }
