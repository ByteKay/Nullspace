...
namespace Nullspace
{
    ...
    public abstract partial class ProcessTimer<TargetType, ValueType>
    {
        ...
        // 发射结束回调
        public UnityAction<ProcessTimer<TargetType, ValueType>, ValueType, ValueType> FinishedProcessAction { get; set; }
        // 发射控制参数消息
        ...
        protected virtual void SetAction(Func<ProcessTimer<TargetType, ValueType>, TargetType, ValueType, ValueType, int> oneProcess, UnityAction<ProcessTimer<TargetType, ValueType>, ValueType, ValueType> finishProcess)
        {
