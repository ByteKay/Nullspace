...
namespace Nullspace
{
    public class FrameTimerTaskHeap
    {
        public static FrameTimerTaskHeap Instance = null;
        static FrameTimerTaskHeap()
        {
            Instance = new FrameTimerTaskHeap();
        }
